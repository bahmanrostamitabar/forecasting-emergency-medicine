...
We have now extended the reproducibility section to say the following:

> R code to produce all results in this paper is available at [github.com/bahmanrostamitabar/forecasting-emergency-medicine](https://github.com/bahmanrostamitabar/forecasting-emergency-medicine). The repository contains the raw data, all R scripts used in experiments as well as the results used in this paper, along with the raw files for producing this paper. Full instructions are provided in the repository. 


[Bahman: can you please fix the spelling of medicine in the name of the repo]
...
We have now added a more detailed but simple example in the introduction.
...
The example in the introduction should serve this purpose.
