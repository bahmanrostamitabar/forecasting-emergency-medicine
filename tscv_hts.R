...
Container <- foreach (i = 1:(n-(k+fh-1)), .combine=rbind, .packages="opera") %dopar% {
...
saveRDS(forecast_all_level,file="forecast_all_level.rds")
saveRDS(testset_all_level,file="testset_all_level.rds")