...
htsplus <- function(object, h,
  ...
  if (is.null(lambda)) {
    ...
    # what is 200?, can we change 0.5 to get different quantiles?
...
# Test on infantgts data
htsplus(infantgts, h = 10, model_function = auto.arima, lambda = 0.5)
htsplus(infantgts, h = 10, model_function = auto.arima, lambda = 0.5, method = "bu")
